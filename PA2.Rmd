...
```
There are `r format(cnt_obs_na, scientific=FALSE)` records in the data set with missing values.
...
```{r transform, echo=TRUE, cache=TRUE}
...
```{r testout, echo=FALSE}
v_ev.cat <- c("AVALNACHE", "BLACK ICE", "BLIZZARD", "COLD", "DAM FAILURE", "DUST", "DROUGHT", "DRY", "EROSION", "FIRE", "FLOOD",
           "FOG", "FREEZE", "FROST", "FUNNEL", "GLAZE", "GUSTNADO", "HAIL", "HEAT", "HIGH SEAS", "HIGH TIDE", "HIGH WATER", "HURRICANE",
           "ICE", "LANDSLIDE", "LANDSPOUT", "LIGHTNING", "LOW TIDE", "MUDSLIDE", "PRECIPITATION", "RAIN", "SMOKE", "SNOW", "SURGE",
           "STORM", "TORNADO", "THUNDERSTORM", "TSTM", "VOLCANIC", "WILDFIRE", "WIND", "WATERSPOUT", "WARMTH", "WET")
v_ev.cat
```
...
```{r population_health, echo=TRUE, results='asis'}
...
```{r economic_damage, echo=TRUE, results='asis'}
...
```{r bar_plots, echo=TRUE, fig.height=8, fig.width=8}
